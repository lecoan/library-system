...
//        });
        ...
        UserPanel.jieyuejb.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                } else if (bookOperate.getBookpathtable(UserPanel.findBookFrame.curBookItem.getIsbn()).getRestnum() > 0 && (!customer.isFreezed()) && customer.getBookedMap().size() < customer.getMaxNumForRent()) {
